...
EnumSet<PascalTokenType> DeclarationsParser::DECLARATION_START_SET =
{
    PT_CONST, PT_TYPE, PT_VAR, PT_PROCEDURE, PT_FUNCTION, PT_BEGIN
};

EnumSet<PascalTokenType> DeclarationsParser::TYPE_START_SET;
EnumSet<PascalTokenType> DeclarationsParser::VAR_START_SET;
EnumSet<PascalTokenType> DeclarationsParser::ROUTINE_START_SET;
