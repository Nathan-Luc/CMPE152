...
void Predefined::initialize_types(SymTabStack *symtab_stack)
{
    ...
    // hour_type = TypeFactory::create_type((TypeForm) TF_SCALAR);
    ...
    symtab_stack->push();
    time_type->set_record_symtab(symtab_stack->get_local_symtab());
    ...
    minute_type = TypeFactory::create_type((TypeForm) TF_SCALAR);
    ...
    second_type = TypeFactory::create_type((TypeForm) TF_SCALAR);
